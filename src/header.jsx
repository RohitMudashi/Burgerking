    ...
    <>
      ...
      <div className="head1">
        ...
        <div className="buttons">
           <img src="https://cloud10.todocoleccion.online/coleccionismo-pegatinas/tc/2019/12/16/20/187628545.webp" alt="" className="img2" />
          ...
          <div className="head2">
              <center>
                 <div className="xy">
              <div className="x">
                  <h1>Start your BK® <br />order.</h1><br /><br />
                          <button className="button1">order pickup</button>
                          <br /><br />
                  <button className="button2">order delivery</button>      
              </div>
